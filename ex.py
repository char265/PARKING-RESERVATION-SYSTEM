...
def new():
   ...
   canvas= Canvas(root13,width = 800, height = 800,bg="black" )
...
def request(curr_user):
   ...
   canvas=Canvas(root12,height=300,width=600,relief="raised",bg="orange").place(x=15,y=30)
...
e4=Label(root,text="Online Parking Reservation System",bg="#b2fab4",font=labelfont).place(x=170,y=50)
c1=Canvas(root,relief="raised",border=2,width=400,height=200,bg="orange").place(x=120,y=100)



l1=Label(c1,text="Registration No.",bg="white",font = "Verdana 8 bold italic").place(x=190,y=130)
e1=Entry(c1,bd=2,textvariable=regno).place(x=300,y=130)
l2=Label(c1,text="Password",bg="white",font = "Verdana 10 bold italic").place(x=190,y=160)
bullet="\u2022"
